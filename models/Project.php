 ...
 * @property Testimomial[] $testimomials
 */
class Project extends \yii\db\ActiveRecord
{
    ...
    /**
     * Gets query for [[Testimomials]].
     *
     * @return \yii\db\ActiveQuery|TestimomialQuery
     */
    public function getTestimomials()
    {
        return $this->hasMany(Testimomial::class, ['project_id' => 'id']);
    }
